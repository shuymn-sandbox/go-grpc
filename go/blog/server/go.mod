module github.com/shuymn-sandbox/go-grpc-sample/go/blog/server
...
require (
	github.com/shuymn-sandbox/go-grpc-sample/go/protobuf/buf/blog v0.0.0-00010101000000-000000000000
